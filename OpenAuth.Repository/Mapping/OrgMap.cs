...
namespace OpenAuth.Repository.Mapping
{
        ...
        : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<OpenAuth.Repository.Domain.Org>
    {
        public OrgMap()
        {
            ...
            Property(t => t.DD_SyncEnabled)
               .HasColumnName("DD_SyncEnabled")
               .IsOptional();

            Property(t => t.DD_SyncStatus)
             .HasColumnName("DD_SyncStatus")
             .IsOptional();

            Property(t => t.DD_SyncMsg)
            .HasColumnName("DD_SyncMsg")
            .IsOptional();

            Property(t => t.DD_SyncMethod)
            .HasColumnName("DD_SyncMethod")
            .IsOptional();
