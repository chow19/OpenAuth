<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RWInspection_Check.aspx.cs" Inherits="QMS_WebSite.IPQCRoute.add.RWInspection_Check" %>
...
<head>
    ...
    <script>
        ...
        function CheckSubmit() {
            ...
            var check7 = $form["check7"];
            if (check7 == "0") {
                $.toptip('请选择检验项目结果', 'error');
                return false;
            }
            var check8 = $form["check8"];
            if (check8 == "0") {
                $.toptip('请选择检验项目结果', 'error');
                return false;
            }
