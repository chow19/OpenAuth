<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bonded_Check.aspx.cs" Inherits="QMS_WebSite.IPQCRoute.add.Bonded_Check" %>
    ...
    <script>
        ...
        function scanModual() {
            $M.scanQrcode(function (qrcode) {
                $.ajax({
                    url: "../../Handler/IPQCRountCheck.ashx?FunType=getMouldInfo&MouldId=" + qrcode,
                    type: "post",
                    cache: false,
                    error: function (XMLHttpRequest, textStatus, e) {
                        $.hideLoading();
