<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RawMaterialIQC_Check_Add.aspx.cs" Inherits="QMS_WebSite.IQC.add.RawMaterialIQC_Check_Add" %>
...
<head>
    ...
    <script>
        ...
        function dataSubmt() {
            ...
            $form["HD_SYC_Images"] = img_SYCarr.join(";");
            ...
            $.ajax({
                url: "../../Handler/IQC.ashx?FunType=RMIQCCheckSubmit&SendQCReportId=" + SQCId,
                type: "post",
                cache: false,
                data: postData,
        ...
        function CheckSubmit() {
            ...
            if (img_BHCarr.length <= 0) {
                $.toptip('保护层厚需上传图片', 'error');
                return false;
            }
            if (img_SYCarr.length <= 0) {
                $.toptip('使用层厚度需上传图片', 'error');
                return false;
            }
            if (img_LCMarr.length <= 0) {
                $.toptip('离膜层厚度需上传图片', 'error');
                return false;
            }
            ...
            if (CB_CB == false && img_CBarr.length <= 0) {
            ...
            <div class="weui-panel__bd">
                ...
                <div class="weui-cells weui-cells_form">
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="myOwn">
                            <input class="weui-input" type="number" name="HD_BHC" placeholder="请输入保护层厚" onkeyup="this.value = this.value.replace(/[^\d\.]/g,'')" onafterpaste="this.value = this.value.replace(/[^\d\.]/g, '')">
                        </div>
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="myOwn">
                            <input class="weui-input" type="number" name="HD_SYC" placeholder="请输入使用层厚度" onkeyup="this.value = this.value.replace(/[^\d\.]/g,'')" onafterpaste="this.value = this.value.replace(/[^\d\.]/g, '')">
                        </div>
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="myOwn">
                            <input class="weui-input" type="number" name="HD_LCM" placeholder="请输入离层膜厚度" onkeyup="this.value = this.value.replace(/[^\d\.]/g,'')" onafterpaste="this.value = this.value.replace(/[^\d\.]/g, '')">
                        </div>
                ...
                <div class="weui-cells weui-cells_form">
                    ...
                    <div class="weui-cell">
                        ...
                        <div class="myOwn">
                            <input class="weui-input" type="number" name="ST_PQSJ" placeholder="请输入排气时间" onkeyup="this.value = this.value.replace(/[^\d\.]/g,'')" onafterpaste="this.value = this.value.replace(/[^\d\.]/g, '')">
                        </div>
                        <div class="weui-cell__bd">
                            <div class="weui-uploader imgspace">
